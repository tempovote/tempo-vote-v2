...
export const mockGovernanceActions: GovernanceAction[] = [
  {
    ...
    drep: { yesAda: "5.13B", yesPercent: 84.89, noAda: "912M", noPercent: 15.11, abstainPercent: 0, threshold: 67 },
    cc: { approved: 7, total: 7, threshold: 66.67 },
  },
  {
    id: "ga-002",
    ...
    status: "Active",
    type: "Treasury Withdrawals",
    drep: { yesAda: "1.09B", yesPercent: 19.43, noAda: "4.65B", noPercent: 79, abstainPercent: 1.57, threshold: 67 },
    cc: { approved: 7, total: 7, threshold: 66.67 },
  },
  {
    id: "ga-003",
    ...
    drep: { yesAda: "1.76B", yesPercent: 28.93, noAda: "4.06B", noPercent: 67.81, abstainPercent: 3.26, threshold: 67 },
    cc: { approved: 6, total: 7, threshold: 66.67 },
  },
  {
    id: "ga-004",
    ...
    status: "Active",
    type: "Treasury Withdrawals",
    drep: { yesAda: "1.98", yesPercent: 31.91, noAda: "4.18", noPercent: 66.72, abstainPercent: 1.37, threshold: 67 },
    cc: { approved: 6, total: 7, threshold: 66.67 },
  },
  {
    id: "ga-005",
    ...
    status: "Active",
    type: "Treasury Withdrawals",
    drep: { yesAda: "2.52B", yesPercent: 53.23, noAda: "2.74B", noPercent: 46.77, abstainPercent: 0, threshold: 67 },
    cc: { approved: 6, total: 7, threshold: 66.67 },
  },
  {
    id: "ga-006",
    ...
    status: "Active",
    type: "Treasury Withdrawals",
    drep: { yesAda: "1.21B", yesPercent: 22.26, noAda: "3.34B", noPercent: 57.74, abstainPercent: 20, threshold: 67 },
    cc: { approved: 5, total: 7, threshold: 66.67 },
  },
  {
    id: "ga-007",
    ...
    status: "Active",
    type: "Treasury Withdrawals",
    drep: { yesAda: "1.09B", yesPercent: 25.83, noAda: "3.89B", noPercent: 70.45, abstainPercent: 3.72, threshold: 67 },
    cc: { approved: 5, total: 7, threshold: 66.67 },
  },
  {
    id: "ga-008",
    ...
    status: "Active",
    type: "Treasury Withdrawals",
    drep: { yesAda: "1.94B", yesPercent: 36.81, noAda: "3.45B", noPercent: 63.19, abstainPercent: 0, threshold: 67 },
    cc: { approved: 5, total: 7, threshold: 66.67 },
  },
]
